    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         a { color:#5D8DAC;background: #FDF0DC; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;border: 2px solid  #C7BBAA;display: flex;justify-content:center;}\
      </style>\
    </head>\
    <body>\
